            ...
            <div class="container">
                ...
                <div class="ht-right">
                    ...
                    <div class="top-social">
                        <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"><i class="ti-facebook"></i></a>
                        <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"><i class="ti-twitter-alt"></i></a>
                        <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"><i class="ti-linkedin"></i></a>
                        <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"><i class="ti-pinterest"></i></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="cart-hover">
                                    <div class="select-items">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="si-pic"><img src="fashi/img/select-product-1.jpg" alt=""></td>
                                                    <td class="si-text">
                                                ...
                                                <tr>
                                                    <td class="si-pic"><img src="fashi/img/select-product-2.jpg" alt=""></td>
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            <p>$60.00 x 1</p>
                                                            <h6>Kabino Bedside Table</h6>
            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="{{route('create_contact')}}">Contact</a></li>
                        <li><a href="#">Pages</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="{{route('registered')}}">Register</a></li>
                                <li><a href="{{route('loggedin')}}">Login</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="#"><img src="fashi/img/footer-logo.png" alt=""></a>
                        </div>
                        <ul>
                        ...
                        <div class="footer-social">
                            <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"><i class="fa fa-instagram"></i></a>
                            <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"><i class="fa fa-twitter"></i></a>
                            <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank"><i class="fa fa-pinterest"></i></a>
                        </div>
                    </div>
                </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        ...
                        <div class="payment-pic">
                            <img src="fashi/img/payment-method.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
